...
def download_corp_action(driver, action_type):
    ...
    purpose = driver.find_element_by_xpath('//*[@id="ddlPurpose"]')
    ...
    selected_purpose = driver.find_element_by_xpath(f'//*[@id="ddlPurpose"]/option[@value=\"{corp_act}\"]')
    ...
    download_csv = driver.find_element_by_xpath('//*[@id="lnkDownload"]/i')
