...
divd = pd.read_csv(r"C:\Users\sba400\Downloads\dividend.csv")
...
divd.to_sql(name='DIVIDEND_DATA', con=conn, if_exists='replace', index=False)
print('Dividend information load is complete!!!')
############################# PART 2 ##################################################
"""
