...
bonus = pd.read_csv(r"C:\Users\sba400\Downloads\bonus.csv")
...
bonus.to_sql(name='BONUS', con=conn, if_exists='replace', index=False)
print('Bonus information load is complete!!!')
