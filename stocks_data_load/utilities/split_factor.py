...
split = pd.read_csv(r"C:\Users\sba400\Downloads\split.csv")
...
split.to_sql(name='SPLIT_DATA', con=conn, if_exists='replace', index=False)
print('Split information load is complete!!!')
